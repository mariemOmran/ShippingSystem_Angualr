...
export const routes: Routes = [
    ...
    {path:'login',component:LoginComponent,pathMatch:'full',canActivate:[isLoginGuard]},
    {path:'',component:LayoutComponent,children:[
        {path:'dashboard',component:MainDashboardComponent}, //,canActivate:[employeeGuard,adminGuard,merchantGuard,deliveryGuard]
        ...
        {path:'report',component:ReportsComponent,canActivate:[adminGuard]},
        ...
        {path:'employee/:id',component:EmployeeFormComponent,canActivate:[adminGuard]},
